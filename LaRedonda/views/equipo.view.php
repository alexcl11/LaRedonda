    ...
    <div class="container m-2">
        <div class="row ">
            <div id="seccionDatos" class="col-sm-5  border rounded py-2">
                <div id="logoEquipo" class="col-6 p-2 rounded" style="background: #8e8c8c;border: solid #dc3545;"></div>
            ...
            <div class="col-sm-6 mx-sm-4 border rounded">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a id="ultimosResultadosLink" class="nav-link text-danger active" href="#">Últimos resultados</a>
                    </li>
                    <li class="nav-item">
